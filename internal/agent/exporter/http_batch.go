...
var _ Exporter = (*HTTPBatchExporter)(nil)
...
// Constructor.
func NewHTTPBatchExporter(ctx context.Context, baseURL *entities.Address, signer security.Signer, publicKey security.PublicKey) *HTTPBatchExporter {
	client := &http.Client{
...
func (e *HTTPBatchExporter) Add(name string, value metrics.Metric) Exporter {
	if e.err != nil {
		return e
	}
...
// Send batch.
func (e *HTTPBatchExporter) Send() error {
	if e.err != nil {
		return e.err
	}
...
// Reset batch.
func (e *HTTPBatchExporter) Reset() {
	e.buffer = make([]metrics.MetricExchange, 0)
	e.err = nil
}

// Get error if any.
func (e *HTTPBatchExporter) Error() error {
	if e.err == nil {
		return nil
	}
...
func (e *HTTPBatchExporter) doSend() error {
